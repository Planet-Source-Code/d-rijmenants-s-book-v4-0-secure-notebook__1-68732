...
'Print module v3 (c) D. Rijmenants 2004
'sub PrintString
...
If printVar = "" Then Exit Sub
gblnPrintBusy = True
frmPage.ProgressBar1.Max = Len(printVar) + 4
...
If gblnCancelPrint = True Then
    ...
    End If
'Update ProgressBar
frmPage.ProgressBar1.Value = staPos
'frmPrintProgress.ProgressBar1.Refresh
Loop While staPos < Len(printVar)
Printer.EndDoc
frmPage.ProgressBar1.Value = 0
frmPage.ProgressBar1.Refresh
gblnPrintBusy = False
End Sub
